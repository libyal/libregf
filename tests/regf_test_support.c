 ...
 */
int regf_test_support_get_narrow_source(
     const system_character_t *source,
     char *narrow_string,
     size_t narrow_string_size,
     libcerror_error_t **error )
{
	static char *function     = "regf_test_support_get_narrow_source";
 ...
 * Returns 1 if successful or -1 on error
 */
int regf_test_support_get_wide_source(
     const system_character_t *source,
     wchar_t *wide_string,
     size_t wide_string_size,
     libcerror_error_t **error )
{
	static char *function   = "regf_test_support_get_wide_source";
     ...
     const system_character_t *source )
{
	...
	/* Initialize test
	 */
	result = regf_test_support_get_narrow_source(
	          source,
	          narrow_source,
	          256,
	          &error );
     ...
     const system_character_t *source )
{
	...
	/* Initialize test
	 */
	result = regf_test_support_get_wide_source(
	          source,
	          wide_source,
	          256,
	          &error );
