...
REGF_TEST_SET_ASCII_CODEPAGE="regf_test_set_ascii_codepage";

if ! test -x ${REGF_TEST_SET_ASCII_CODEPAGE};
then
	REGF_TEST_SET_ASCII_CODEPAGE="regf_test_set_ascii_codepage.exe";
fi

if ! test -x ${REGF_TEST_SET_ASCII_CODEPAGE};
then
	echo "Missing executable: ${REGF_TEST_SET_ASCII_CODEPAGE}";
...
do
	...
	${TEST_RUNNER} ./${REGF_TEST_SET_ASCII_CODEPAGE} ${CODEPAGE};
