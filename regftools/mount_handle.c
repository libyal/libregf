...
int mount_handle_get_key_by_path(
     ...
     libcerror_error_t **error )
{
	libcstring_system_character_t *regf_path = NULL;
	...
	regf_path_length = libcstring_system_string_length(
	                    regf_path );
	...
	if( ( normalized_regf_path_length >= 1 )
	 && ( regf_path[ normalized_regf_path_length - 1 ] == (libcstring_system_character_t) '\\' ) )
	{
		normalized_regf_path_length -= 1;
	}
	if( ( normalized_regf_path_length >= 12 )
	 && ( regf_path[ normalized_regf_path_length - 12 ] == (libcstring_system_character_t) '\\' )
	       ...
	       11 ) == 0 ) )
	{
		regf_path_length = normalized_regf_path_length - 12;
	      ...
	      && ( regf_path[ normalized_regf_path_length - 9 ] == (libcstring_system_character_t) '\\' )
	      && ( libcstring_system_string_compare(
