...
#if !defined( _REGFTOOLS_GETOPT_H )
#define _REGFTOOLS_GETOPT_H
...
typedef struct regftools_option regftools_option_t;

struct regftools_option
{
...
#define regftools_getopt( argument_count, argument_values, options_string ) \
...
system_integer_t regftools_getopt(
                  int argument_count,
...
void regftools_getopt_wrapped_fprint(
      FILE *stream,
...
void regftools_getopt_usage_fprint(
      FILE *stream,
      const char *program,
      const char *description,
      const regftools_option_t *options,
      int number_of_options );

int regftools_getopt_get_options_string(
     const regftools_option_t *options,
     int number_of_options,
...
#endif /* !defined( _REGFTOOLS_GETOPT_H ) */
