...
then
	...
	docker exec -e "DEBIAN_FRONTEND=noninteractive" ${CONTAINER_NAME} sh -c "apt-get install -y autoconf automake build-essential libtool pkg-config autopoint libfuse-dev";
