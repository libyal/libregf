...
{
	static char *function = "libregf_notify_set_stream";
...
int libregf_notify_stream_open(
     ...
     libcerror_error_t **error )
{
	static char *function = "libregf_notify_stream_open";
...
int libregf_notify_stream_close(
     libcerror_error_t **error )
{
	static char *function = "libregf_notify_stream_close";
