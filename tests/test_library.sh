...
LIBRARY_TESTS="data_type error hive_bin hive_bin_cell hive_bins_list io_handle key key_item named_key notify value value_item";
...
run_test_with_input()
{
	...
	run_test_on_input_directory "libregf" "${TEST_DESCRIPTION}" "default" "${OPTION_SETS}" "${TEST_EXECUTABLE}" "input" "${INPUT_GLOB}";
	local RESULT=$?;
