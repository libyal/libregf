           ...
           int64_t value_64bit )
{
	...
	static char *function    = "pyregf_integer_signed_new_from_64bit";
...
{
	PyObject *integer_object = NULL;
	static char *function    = "pyregf_integer_unsigned_new_from_64bit";
...
{
	static char *function   = "pyregf_integer_signed_copy_to_64bit";
	int result              = 0;
...
int pyregf_integer_unsigned_copy_to_64bit(
     ...
     libcerror_error_t **error )
{
	static char *function   = "pyregf_integer_unsigned_copy_to_64bit";
	int result              = 0;
