 ...
 */
PyObject *pyregf_datetime_new_from_time_elements(
           uint16_t year,
           ...
           uint32_t micro_seconds )
{
	...
	static char *function     = "pyregf_datetime_new_from_time_elements";
...
{
	PyObject *datetime_object = NULL;
	static char *function     = "pyregf_datetime_new_from_fat_date_time";
	uint16_t year             = 0;
	uint8_t day_of_month      = 0;
	uint8_t days_in_month     = 0;
	uint8_t hours             = 0;
           ...
           uint64_t filetime )
{
	...
	datetime_object = pyregf_datetime_new_from_time_elements(
	                   year,
	                   filetime,
	                   hours,
	                   minutes,
           ...
           uint64_t floatingtime )
{
	...
	PyObject *datetime_object = NULL;
	static char *function     = "pyregf_datetime_new_from_floatingtime";
	uint32_t days_in_century  = 0;
	uint32_t micro_seconds    = 0;
	uint16_t days_in_year     = 0;
	uint16_t year             = 0;
 ...
 * Returns a Python object if successful or NULL on error
 */
PyObject *pyregf_datetime_new_from_hfs_time(
           uint32_t hfs_time )
{
	PyObject *datetime_object = NULL;
	uint16_t year             = 0;
 ...
 * Returns a Python object if successful or NULL on error
 */
PyObject *pyregf_datetime_new_from_posix_time_in_micro_seconds(
           int64_t posix_time )
{
	PyObject *datetime_object = NULL;
	uint32_t micro_seconds    = 0;
