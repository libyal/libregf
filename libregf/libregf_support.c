...
/* Determines if a file is a PPF file (check for the REGF file signature)
...
/* Determines if a file is a REGF file (check for the REGF file signature)
 * Returns 1 if true, 0 if not or -1 on error
 */
...
/* Determines if a file is a REGF file (check for the REGF file signature) using a Basic File IO (bfio) handle
 * Returns 1 if true, 0 if not or -1 on error
 */
