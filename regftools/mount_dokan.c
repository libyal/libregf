...
extern mount_handle_t *regfmount_mount_handle;
...
NTSTATUS __stdcall mount_dokan_ZwCreateFile(
                    const wchar_t *path,
                    DOKAN_IO_SECURITY_CONTEXT *security_context REGFTOOLS_ATTRIBUTE_UNUSED,
                    ACCESS_MASK desired_access,
                    ULONG file_attributes REGFTOOLS_ATTRIBUTE_UNUSED,
                    ULONG share_access REGFTOOLS_ATTRIBUTE_UNUSED,
                    ULONG creation_disposition,
                    ULONG creation_options REGFTOOLS_ATTRIBUTE_UNUSED,
                    DOKAN_FILE_INFO *file_info )
{
	libcerror_error_t *error = NULL;
	...
	REGFTOOLS_UNREFERENCED_PARAMETER( security_context )
	REGFTOOLS_UNREFERENCED_PARAMETER( file_attributes )
	REGFTOOLS_UNREFERENCED_PARAMETER( share_access )
	REGFTOOLS_UNREFERENCED_PARAMETER( creation_options )
