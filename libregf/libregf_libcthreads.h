...
#if !defined( _LIBREGF_LIBCTHREADS_H )
#define _LIBREGF_LIBCTHREADS_H

#include <common.h>

#if defined( HAVE_MULTI_THREAD_SUPPORT ) && !defined( HAVE_LOCAL_LIBREGF )
#define HAVE_LIBREGF_MULTI_THREAD_SUPPORT
#endif
...
#endif /* defined( HAVE_LIBREGF_MULTI_THREAD_SUPPORT ) */

#endif /* !defined( _LIBREGF_LIBCTHREADS_H ) */
