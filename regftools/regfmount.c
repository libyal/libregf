...
#endif
{
	...
	struct fuse_args regfmount_fuse_arguments   = FUSE_ARGS_INIT(1, fuse_argv);
#else
	...
	if( option_extended_options != NULL )
	{
		...
		regfmount_fuse_arguments.argc = 0;
		regfmount_fuse_arguments.argv = NULL;
#endif
	...
	regfmount_dokan_options.SingleThread = TRUE;
#else
...
*/
	...
	fprintf(
	 stderr,
	 "No sub system to mount Windows NT Registry File (REGF) format.\n" );
